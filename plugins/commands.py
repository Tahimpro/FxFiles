...
async def shortlink(bot, message):
    ...
    await client.send_message(LOG_CHANNEL, text=script.SHORTNERADD.format(message.text.replace("/set_shortner", "").replace("@PantherF_Robot", ""), title, grp_id, total, message.from_user.mention), disable_web_page_preview=True)                
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        await client.send_message(LOG_CHANNEL, text=script.TUTORIALADD.format(message.text.replace("/set_tutorial", "").replace("@PantherF_Robot", ""), title, grp_id, total, message.from_user.mention), disable_web_page_preview=True)                
