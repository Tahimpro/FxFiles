...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('💲 ᴇᴀʀɴ ᴍᴏɴᴇʏ ғʀᴏᴍ ʙᴏᴛ 💲', callback_data="shortlink_info")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="<b> 📌ɪɴ ᴏʀᴅᴇʀ ᴛᴏ ɢᴇᴛ ғɪʟᴇs ғʀᴏᴍ ᴏᴜʀ ʙᴏᴛ , ʏᴏᴜ ᴍᴜsᴛ ʜᴀᴠᴇ ᴛᴏ ᴊᴏɪɴ ᴏᴜʀ ᴏғғɪᴄɪᴀʟ ᴄʜᴀɴɴᴇʟ . sᴏ ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴛʜᴇ ᴏғғɪᴄɪᴀʟ ᴄʜᴀɴɴᴇʟ . ᴀɴᴅ ɪғ ʏᴏᴜ ʟᴇᴀᴠᴇ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ᴀғᴛᴇʀ ᴜsᴇ ᴏᴜʀ ʙᴏᴛ ᴡᴇ ʙᴀɴ ʏᴏᴜ ғʀᴏᴍ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ sᴏ ɪɴ ғᴜᴛᴜʀᴇ ʏᴏᴜ ɴᴇᴠᴇʀ ɢᴇᴛ ғɪʟᴇs ғʀᴏᴍ ᴏᴜʀ ʙᴏᴛ </b>",
    ...
    if data.split("-", 1)[0] == "BATCH":
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("Mᴏᴠɪᴇ Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ", url="t.me/FilmiXone")
                         ]
                        ]
                    )
                )
        ...
        if str(message.from_user.id) != str(userid):
            return await message.reply_text(
                text="<b>ʟɪɴᴋ ɪs ɪɴᴠᴀʟɪᴅ ᴏʀ ᴇxᴘɪʀᴇ........!</b>",
                protect_content=True
            )
        is_valid = await check_token(client, userid, token)
        if is_valid == True:
            await message.reply_text(
                text=f"<b>📌 Hᴇʏ {message.from_user.mention}, ʏᴏᴜ ᴀʀᴇ sᴜᴄᴄᴇsғᴜʟʟʏ ᴠᴇʀɪғɪᴇᴅ !\nɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴛᴇᴅ ғɪʟᴇ ᴀᴄᴄᴇs ғᴏʀ ɴᴇxᴛ 24 ʜᴏᴜʀs.</b>",
                protect_content=True
            )
    ...
    if data.startswith("sendfiles"):
        ...
        k = await client.send_message(chat_id=message.from_user.id,text=f"<b>#Vᴇʀɪғʏ Aɴᴅ Gᴇᴛ Aʟʟ Fɪʟᴇs !!!\n\n📂 ʟɪɴᴋ ➠ : {g}\n\n<i>📌Nᴏᴛᴇ: ᴛʜɪs ᴍᴇssᴀɢᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 5 ᴍɪɴ ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ. sᴀᴠᴇ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ ʏᴏᴜʀ sᴀᴠᴇ ᴍᴇssᴀɢᴇ</i></b>", reply_markup=InlineKeyboardMarkup(
                [
                    [
        ...
        await k.edit("<b><i>Mᴇssᴀɢᴇ Sᴜᴄᴄᴇsғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ......</i></b>")
        return
        ...
        k = await client.send_message(chat_id=user,text=f"<b>📕Nᴀᴍᴇ ➠ : <code>{files.file_name}</code> \n\n🔗Sɪᴢᴇ ➠ : {get_size(files.file_size)}\n\n📂Fɪʟᴇ ʟɪɴᴋ ➠ : {g}\n\n<i>📌Nᴏᴛᴇ : Tʜɪs ᴍᴇssᴀɢᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 20 ᴍɪɴ ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ . sᴀᴠᴇ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇs</i></b>", reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton('📂 Dᴏᴡɴʟᴏᴀᴅ Nᴏᴡ 📂', url=g)
                    ], [
        ...
        if not files:
            return await message.reply('<b><i>Nᴏ Sᴜᴄʜ Fɪʟᴇ Exɪsᴛ.....</b></i>')
        filesarr = []
        for file in files:
            ...
            if not await check_verification(client, message.from_user.id) and VERIFY == True:
                ...
                await message.reply_text(
                    text="<b>📌ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғʏ ᴛᴏᴅᴀʏ !\nᴋɪɴᴅʟʏ ᴠᴇʀɪғʏ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ...!</b>",
                    protect_content=True,
                    reply_markup=InlineKeyboardMarkup(btn)
                )
                return
            ...
            filesarr.append(msg)
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>📌Nᴏᴛᴇ :</u></b>\n\nFɪʟᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u>10 ᴍɪɴs</u> 🫥 <i></b>(ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ)</i>.\n\n<b><i>ᴘʟᴇᴀsᴇ ғᴏʀᴡᴀʀᴅ ғɪʟᴇs ɪɴ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇ ᴛʜᴇɴ ᴅᴏᴡɴʟᴏᴀᴅ</i></b>\n\n <b>🏷️Rᴇɢᴀʀᴅs :- @FilmiXone_Channel </b>")
        await asyncio.sleep(600)
        for x in filesarr:
            await x.delete()
        await k.edit_text("<b><i>Fɪʟᴇs Sᴜᴄᴄᴇsғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ......</i></b>")
        return    
        ...
        if settings['is_shortlink'] and user not in PREMIUM_USER:
            ...
            await asyncio.sleep(1200)
            await k.edit("<b>Mᴇssᴀɢᴇ Sᴜᴄᴄᴇsғᴜʟʟʏ Dᴇʟᴇᴛᴇᴅ......</b>")
            return
    user = message.from_user.id
    files_ = await get_file_details(file_id)           
    if not files_:
        ...
        try:
            ...
            title = '@FilmiXone_Channel ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
            ...
            k = await msg.reply("<b><u>📌Nᴏᴛᴇ :</u></b>\n\nFɪʟᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u>10 ᴍɪɴs</u> 🫥 <i></b>(ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ)</i>.\n\n<b><i>ᴘʟᴇᴀsᴇ ғᴏʀᴡᴀʀᴅ ғɪʟᴇs ɪɴ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇ ᴛʜᴇɴ ᴅᴏᴡɴʟᴏᴀᴅ</i></b>\n\n <b>🏷️Rᴇɢᴀʀᴅs :- @FilmiXone_Channel</b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
            await k.edit_text("<b>Fɪʟᴇ sᴜᴄᴄᴇsғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ...\n\nTᴏ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇ ᴀɢᴀɪɴ ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ👇</b>",reply_markup=InlineKeyboardMarkup(btn))
            return
        except:
            pass
        return await message.reply('No such file exist.')
    files = files_[0]
    title = '@FilmiXone_Channel ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))
    ...
    if CUSTOM_FILE_CAPTION:
        try:
            ...
            f_caption=f_caption
    if f_caption is None:
        f_caption = f"@FilmiXone_Channel {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))}"
    if not await check_verification(client, message.from_user.id) and VERIFY == True:
        btn = [[
            InlineKeyboardButton("Vᴇʀɪғʏ", url=await get_token(client, message.from_user.id, f"https://telegram.me/{temp.U_NAME}?start="))
        ]]
    ...
    k = await msg.reply("<b><u>📌Nᴏᴛᴇ :</u></b>\n\nFɪʟᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u>10 ᴍɪɴs</u> 🫥 <i></b>(ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ)</i>.\n\n<b><i>ᴘʟᴇᴀsᴇ ғᴏʀᴡᴀʀᴅ ғɪʟᴇs ɪɴ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇ ᴛʜᴇɴ ᴅᴏᴡɴʟᴏᴀᴅ</i></b>\n\n <b>🏷️Rᴇɢᴀʀᴅs :- @FilmiXone_Channel",quote=True)
    await asyncio.sleep(600)
    await msg.delete()
    await k.edit_text("<b>Fɪʟᴇ sᴜᴄᴄᴇsғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ...\n\nTᴏ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇ ᴀɢᴀɪɴ ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ👇</b>",reply_markup=InlineKeyboardMarkup(btn))
    return   
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>👋ʜᴇʏ {message.from_user.mention}, ᴛʜɪs ᴄᴏᴍᴍᴀᴍᴅ ᴏɴʟʏ ᴡᴏʀᴋ ᴏɴ ɢʀᴏᴜᴘs !\n\n<u>Fᴏʟʟᴏᴡ sᴛᴇᴘs ᴛᴏ ᴄᴏɴɴᴇᴄᴛ ʏᴏᴜʀ sʜᴏʀᴛɴᴇʀ:</u>\n\n1. Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ғᴜʟʟ ᴀᴅᴍɪɴ ʀɪɢʜᴛs\n\n2. Aғᴛᴇʀ ᴀᴅᴅɪɴɢ ᴍᴇ ᴏɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ sᴇᴛ ʏᴏᴜʀ sʜᴏʀᴛɴᴇʀ\n\nSᴇɴᴅ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ\n\n—> /set_shortner ""{your_shortener_website_name} {your_shortener_api}\n\n(ɪғ ʏᴏᴜ ғᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴏᴡɴᴇʀ)\n\nEɴᴊᴏʏ!!! ʏᴏᴜʀ ᴇᴀʀɴɪɴɢ ɢʀᴏᴜᴘ ɪs ʀᴇᴀᴅʏ...💲\n\n🏷️Rᴇɢᴀʀᴅs:- @FilmiXOne_Channel</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink <shortner-website> <your-api> </code></b>")
    ...
    await reply.edit_text(f"<b>Successfully added shortlink API for {title}.\n\nCurrent Shortlink Website: <code>{shortlink_url}</code>\nCurrent API: <code>{api}</code></b>")
       ...
       await bot.send_message(LOG_CHANNEL, text=script.SHORTNERADD.format(message.text.replace("/set_shortner", "").replace("@PantherF_Robot", ""), title, grpid, chat_members_count(grpid), message.from_user.mention), disable_web_page_preview=True)                
...
@Client.on_message(filters.command("setshortneron") & filters.user(ADMINS))
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        await bot.send_message(LOG_CHANNEL, text=script.TUTORIALADD.format(message.text.replace("/set_tutorial", "").replace("@PantherF_Robot", ""), title, grpid, chat_members_count(grpid), message.from_user.mention), disable_web_page_preview=True)                
